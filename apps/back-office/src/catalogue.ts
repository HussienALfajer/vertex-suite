...
const own = {
  ...
  'nav.rateReviews': 'مراجعة الأسعار بعد الصرف',
  'permission.prc.rate-review.view': 'الاطلاع على مهام مراجعة الأسعار بعد تغيّر سعر الصرف',
  'permission.prc.rate-review.approve': 'استبعاد أسعار مهام المراجعة ورفضها واعتمادها',
  'permission.prc.rate-review-policy.edit': 'تحديد عتبة تغيّر سعر الصرف لمراجعة الأسعار',
  'refusal.prc.threshold-invalid':
    'العتبة نسبة مئوية من {min} إلى {max} بمنزلتين عشريتين على الأكثر، أو تُترك فارغة لإيقاف المراقبة.',
  'refusal.prc.review-not-found': 'مهمة المراجعة هذه غير موجودة في هذا الفرع.',
  'refusal.prc.review-not-pending': 'هذه المهمة لم تعد بانتظار قرار. أعد تحميلها لترى حالتها.',
  'refusal.prc.review-stale':
    'تغيّر {stale} من الأسعار المدرجة منذ إعداد المهمة (سعر بالدولار أو سعر عرض معتمد). حدّث المهمة وراجع أسعارها من جديد قبل الاعتماد.',
  'refusal.prc.review-superseded':
    'تغيّر سعر صرف اليوم أو عتبة المراجعة منذ إنشاء هذه المهمة، فلم تعد صالحة للاعتماد. ستظهر مهمة جديدة إن تجاوز السعر الجديد العتبة.',
  'refusal.prc.review-empty':
    'كل الأسعار في هذه المهمة مستبعدة، فلا شيء لاعتماده. ارفض المهمة بدلًا من ذلك.',
  'refusal.prc.review-query-invalid': 'طلب صفحة المراجعة غير صالح.',
  'rateReviews.title': 'مراجعة الأسعار بعد تغيّر سعر الصرف',
  'rateReviews.description':
    'حين يبتعد سعر صرف اليوم عن السعر الذي اعتُمد عليه سعر العرض بأكثر من العتبة، تُنشأ مهمة مراجعة. لا يتغيّر أي سعر عرض إلا باعتماد دفعة مراجَعة.',
  'rateReviews.policy': 'عتبة تغيّر سعر الصرف',
  'rateReviews.policy.current':
    'العتبة الحالية {threshold}% من سعر الصرف الذي اعتُمد عليه كل سعر، لكل فروع المتجر.',
  'rateReviews.policy.disabled': 'المراقبة متوقفة: لا تُنشأ مهام مراجعة مهما تغيّر سعر الصرف.',
  'rateReviews.policy.threshold': 'العتبة (٪)',
  'rateReviews.policy.help':
    'من 0.1 إلى 50، بمنزلتين عشريتين على الأكثر. يبلغ السعرُ العتبةَ عند مساواتها أيضًا.',
  'rateReviews.policy.save': 'حفظ العتبة',
  'rateReviews.policy.disable': 'إيقاف المراقبة',
  'rateReviews.policy.saved': 'حُفظت عتبة المراجعة.',
  'rateReviews.tasks': 'مهام المراجعة',
  'rateReviews.branch': 'الفرع',
  'rateReviews.chooseBranch': 'اختر فرعًا لعرض مهام المراجعة فيه.',
  'rateReviews.noTasks': 'لا توجد مهام مراجعة لهذا الفرع.',
  'rateReviews.raisedAt': 'أُنشئت',
  'rateReviews.state': 'الحالة',
  'rateReviews.rate': 'سعر الصرف',
  'rateReviews.rateOf': '{rate} ليوم {day} (المراجعة {sequence})',
  'rateReviews.counts': 'الأسعار',
  'rateReviews.countsOf': '{entries} مدرجة، {excluded} مستبعدة',
  'rateReviews.open': 'فتح المهمة',
  'rateReviews.more': 'مهام أقدم',
  'rateReviews.state.preparing': 'قيد الإعداد',
  'rateReviews.state.pending': 'بانتظار المراجعة',
  'rateReviews.state.approving': 'قيد النشر',
  'rateReviews.state.approved': 'معتمدة',
  'rateReviews.state.rejected': 'مرفوضة',
  'rateReviews.state.superseded': 'حلّت محلها مهمة أحدث',
  'rateReviews.task': 'مهمة مراجعة',
  'rateReviews.basis':
    'سعر شراء {currency} لليوم {day} (المراجعة {sequence}): {rate} لكل 1 {functional}، بعتبة {threshold}%.',
  'rateReviews.progress.preparing': 'جارٍ إعداد المهمة: فُحص {scanned} من {frozen} سعرًا معتمدًا.',
  'rateReviews.progress.approving':
    'جارٍ نشر الدفعة: جُهّز {staged} من {total}. لا يظهر أي سعر جديد حتى تُنشر الدفعة كاملة؛ إن توقّف الخادم تُستأنف من حيث وصلت.',
  'rateReviews.failure.stale':
    'لم تُنشر الدفعة: تغيّر {stale} من أسعارها قبل النشر، ولم يُنشر منها شيء. حدّث المهمة وراجعها من جديد.',
  'rateReviews.failure.superseded':
    'لم تُنشر الدفعة: تغيّر سعر الصرف أو العتبة قبل النشر، ولم يُنشر منها شيء.',
  'rateReviews.decision.approved': 'اعتمدها {actor} في {at}: {reason}. نُشرت {total} سعرًا.',
  'rateReviews.decision.rejected': 'رفضها {actor} في {at}: {reason}.',
  'rateReviews.supersession.rate-revised': 'حلّت محلها مهمة أحدث: سُجّل سعر صرف جديد لليوم.',
  'rateReviews.supersession.policy-changed': 'حلّت محلها مهمة أحدث: تغيّرت عتبة المراجعة.',
  'rateReviews.supersession.refreshed': 'حُدّثت: أُعيد إعداد أسعارها في مهمة جديدة.',
  'rateReviews.skipped':
    'لم يُدرج: {listInactive} في قوائم مسحوبة، {subjectInvalid} لأصناف أو وحدات لم تعد موجودة، {usdMissing} بلا سعر بالدولار، {unchanged} لا يتغير رقمها بعد التقريب، {amountInvalid} يُقرَّب إلى صفر.',
  'rateReviews.entries': 'الأسعار المدرجة',
  'rateReviews.noEntries': 'لا توجد أسعار في هذه الصفحة.',
  'rateReviews.entries.help':
    'حدّد الصفوف بمفتاح المسافة ثم استبعدها أو أعدها. الاستبعاد يترك سعر العرض المعتمد كما هو.',
  'rateReviews.item': 'الصنف',
  'rateReviews.list': 'القائمة',
  'rateReviews.unit': 'الوحدة',
  'rateReviews.current': 'المعتمد حاليًا',
  'rateReviews.proposed': 'المقترح',
  'rateReviews.usd': 'السعر بالدولار',
  'rateReviews.usdOf': '{amount} USD (المراجعة {revision})',
  'rateReviews.frozenAt': 'بسعر {rate} ليوم {day}',
  'rateReviews.exactOf': 'قبل التقريب {exact}',
  'rateReviews.status': 'في الدفعة',
  'rateReviews.included': 'مدرج',
  'rateReviews.excluded': 'مستبعد',
  'rateReviews.stale': 'تغيّر منذ الإعداد',
  'rateReviews.exclude': 'استبعاد المحدد',
  'rateReviews.include': 'إعادة المحدد',
  'rateReviews.nextPage': 'الصفحة التالية',
  'rateReviews.firstPage': 'الصفحة الأولى',
  'rateReviews.refresh': 'تحديث المهمة',
  'rateReviews.refreshed':
    'حُدّثت المهمة: ستظهر المهمة الجديدة بأسعارها الحالية واستبعاداتك نفسها في قائمة المهام.',
  'rateReviews.reason': 'سبب القرار',
  'rateReviews.reject': 'رفض المهمة',
  'rateReviews.rejected': 'رُفضت المهمة. بقيت أسعار العرض المعتمدة كما هي.',
  'rateReviews.approve': 'اعتماد الدفعة',
  'rateReviews.approveNote':
    'يعتمد الأسعار المدرجة فقط ({included} سعرًا) بأرقامها المعروضة، ويسجل كل تغيير باسمك وسببك. لا يطبع ملصقًا ولا يغيّر سعر الصندوق بعد.',
  'rateReviews.accepted': 'قُبل الاعتماد، وتُنشر الدفعة الآن.',
  'rateReviews.reload': 'إعادة التحميل',
