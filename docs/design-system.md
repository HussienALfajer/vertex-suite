...
The rule that makes this worth the layers: **per-tenant branding (§4.7) and every future theme change happen in the semantic layer alone.** A screen that reaches past it to a primitive breaks that, and is a review finding.
